...
If the distribution package is absent or too old, install an
operator-managed compatible Bubblewrap that provides a trusted
`/usr/bin/bwrap`. Yeet does not supply a sysctl workaround, disable AppArmor,
or relax host-wide user-namespace restrictions.
