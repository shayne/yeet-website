...
Catch never disables AppArmor or changes a host-wide user-namespace sysctl. If
the managed path contains different content, Catch preserves it and stops with
